...
def ONI_CREATE_API_VERSION(major, minor):
...
class OniStatus(CEnum):
    _names_ = {'ONI_STATUS_NOT_SUPPORTED': 3,
               ...
               'ONI_STATUS_ERROR': 1,
               'ONI_STATUS_NOT_IMPLEMENTED': 2, 'ONI_STATUS_NO_DEVICE': 6, 'ONI_STATUS_OUT_OF_FLOW': 5, 'ONI_STATUS_BAD_PARAMETER': 4}
    _values_ = {0: 'ONI_STATUS_OK', 1: 'ONI_STATUS_ERROR', 2: 'ONI_STATUS_NOT_IMPLEMENTED', 3: 'ONI_STATUS_NOT_SUPPORTED',
                4: 'ONI_STATUS_BAD_PARAMETER', 5: 'ONI_STATUS_OUT_OF_FLOW', 6: 'ONI_STATUS_NO_DEVICE', 102: 'ONI_STATUS_TIME_OUT'}
    ONI_STATUS_OK = 0
    ONI_STATUS_ERROR = 1
...
class OniPixelFormat(CEnum):
    _names_ = {'ONI_PIXEL_FORMAT_RGB888': 200, 'ONI_PIXEL_FORMAT_JPEG': 204, 'ONI_PIXEL_FORMAT_GRAY8': 202, 'ONI_PIXEL_FORMAT_DEPTH_1_MM': 100, 'ONI_PIXEL_FORMAT_YUYV': 205,
               'ONI_PIXEL_FORMAT_YUV422': 201, 'ONI_PIXEL_FORMAT_SHIFT_9_3': 103, 'ONI_PIXEL_FORMAT_SHIFT_9_2': 102, 'ONI_PIXEL_FORMAT_GRAY16': 203, 'ONI_PIXEL_FORMAT_DEPTH_100_UM': 101}
    _values_ = {100: 'ONI_PIXEL_FORMAT_DEPTH_1_MM', 101: 'ONI_PIXEL_FORMAT_DEPTH_100_UM', 102: 'ONI_PIXEL_FORMAT_SHIFT_9_2', 103: 'ONI_PIXEL_FORMAT_SHIFT_9_3', 200: 'ONI_PIXEL_FORMAT_RGB888',
                201: 'ONI_PIXEL_FORMAT_YUV422', 202: 'ONI_PIXEL_FORMAT_GRAY8', 203: 'ONI_PIXEL_FORMAT_GRAY16', 204: 'ONI_PIXEL_FORMAT_JPEG', 205: 'ONI_PIXEL_FORMAT_YUYV'}
...
class OniDeviceState(CEnum):
    _names_ = {'ONI_DEVICE_STATE_ERROR': 1, 'ONI_DEVICE_STATE_NOT_READY': 2,
               'ONI_DEVICE_STATE_EOF': 3, 'ONI_DEVICE_STATE_OK': 0}
    _values_ = {0: 'ONI_DEVICE_STATE_OK', 1: 'ONI_DEVICE_STATE_ERROR',
                2: 'ONI_DEVICE_STATE_NOT_READY', 3: 'ONI_DEVICE_STATE_EOF'}
...
class _anon_enum_16(CEnum):
    _names_ = {'ONI_DEVICE_PROPERTY_PLAYBACK_SPEED': 100, 'ONI_DEVICE_PROPERTY_IMAGE_REGISTRATION': 5, 'ONI_DEVICE_PROPERTY_DRIVER_VERSION': 1, 'ONI_DEVICE_PROPERTY_PLAYBACK_REPEAT_ENABLED': 101,
               'ONI_DEVICE_PROPERTY_ERROR_STATE': 4, 'ONI_DEVICE_PROPERTY_HARDWARE_VERSION': 2, 'ONI_DEVICE_PROPERTY_FIRMWARE_VERSION': 0, 'ONI_DEVICE_PROPERTY_SERIAL_NUMBER': 3}
    _values_ = {0: 'ONI_DEVICE_PROPERTY_FIRMWARE_VERSION', 1: 'ONI_DEVICE_PROPERTY_DRIVER_VERSION', 2: 'ONI_DEVICE_PROPERTY_HARDWARE_VERSION', 3: 'ONI_DEVICE_PROPERTY_SERIAL_NUMBER',
                4: 'ONI_DEVICE_PROPERTY_ERROR_STATE', 5: 'ONI_DEVICE_PROPERTY_IMAGE_REGISTRATION', 100: 'ONI_DEVICE_PROPERTY_PLAYBACK_SPEED', 101: 'ONI_DEVICE_PROPERTY_PLAYBACK_REPEAT_ENABLED'}
...
class _anon_enum_17(CEnum):
    _names_ = {'ONI_STREAM_PROPERTY_MIRRORING': 7, 'ONI_STREAM_PROPERTY_GAIN': 103, 'ONI_STREAM_PROPERTY_NUMBER_OF_FRAMES': 8, 'ONI_STREAM_PROPERTY_AUTO_EXPOSURE': 101, 'ONI_STREAM_PROPERTY_STRIDE': 6, 'ONI_STREAM_PROPERTY_HORIZONTAL_FOV': 1,
               'ONI_STREAM_PROPERTY_MIN_VALUE': 5, 'ONI_STREAM_PROPERTY_VERTICAL_FOV': 2, 'ONI_STREAM_PROPERTY_MAX_VALUE': 4, 'ONI_STREAM_PROPERTY_CROPPING': 0, 'ONI_STREAM_PROPERTY_EXPOSURE': 102, 'ONI_STREAM_PROPERTY_AUTO_WHITE_BALANCE': 100, 'ONI_STREAM_PROPERTY_VIDEO_MODE': 3}
    _values_ = {0: 'ONI_STREAM_PROPERTY_CROPPING', 1: 'ONI_STREAM_PROPERTY_HORIZONTAL_FOV', 2: 'ONI_STREAM_PROPERTY_VERTICAL_FOV', 3: 'ONI_STREAM_PROPERTY_VIDEO_MODE', 4: 'ONI_STREAM_PROPERTY_MAX_VALUE', 5: 'ONI_STREAM_PROPERTY_MIN_VALUE', 6: 'ONI_STREAM_PROPERTY_STRIDE',
                7: 'ONI_STREAM_PROPERTY_MIRRORING', 8: 'ONI_STREAM_PROPERTY_NUMBER_OF_FRAMES', 103: 'ONI_STREAM_PROPERTY_GAIN', 100: 'ONI_STREAM_PROPERTY_AUTO_WHITE_BALANCE', 102: 'ONI_STREAM_PROPERTY_EXPOSURE', 101: 'ONI_STREAM_PROPERTY_AUTO_EXPOSURE'}
...
class XnFWVer(CEnum):
    _names_ = {'XN_SENSOR_FW_VER_5_6': 12, 'XN_SENSOR_FW_VER_5_2': 8, 'XN_SENSOR_FW_VER_5_0': 6, 'XN_SENSOR_FW_VER_5_1': 7, 'XN_SENSOR_FW_VER_0_17': 1, 'XN_SENSOR_FW_VER_5_3': 9, 'XN_SENSOR_FW_VER_5_4': 10,
               'XN_SENSOR_FW_VER_1_1': 2, 'XN_SENSOR_FW_VER_1_2': 3, 'XN_SENSOR_FW_VER_5_7': 13, 'XN_SENSOR_FW_VER_5_8': 14, 'XN_SENSOR_FW_VER_4_0': 5, 'XN_SENSOR_FW_VER_UNKNOWN': 0, 'XN_SENSOR_FW_VER_3_0': 4, 'XN_SENSOR_FW_VER_5_5': 11}
    _values_ = {0: 'XN_SENSOR_FW_VER_UNKNOWN', 1: 'XN_SENSOR_FW_VER_0_17', 2: 'XN_SENSOR_FW_VER_1_1', 3: 'XN_SENSOR_FW_VER_1_2', 4: 'XN_SENSOR_FW_VER_3_0', 5: 'XN_SENSOR_FW_VER_4_0', 6: 'XN_SENSOR_FW_VER_5_0',
                7: 'XN_SENSOR_FW_VER_5_1', 8: 'XN_SENSOR_FW_VER_5_2', 9: 'XN_SENSOR_FW_VER_5_3', 10: 'XN_SENSOR_FW_VER_5_4', 11: 'XN_SENSOR_FW_VER_5_5', 12: 'XN_SENSOR_FW_VER_5_6', 13: 'XN_SENSOR_FW_VER_5_7', 14: 'XN_SENSOR_FW_VER_5_8'}
...
class XnSensorVer(CEnum):
    _names_ = {'XN_SENSOR_VER_3_0': 2, 'XN_SENSOR_VER_4_0': 3,
               'XN_SENSOR_VER_5_0': 4, 'XN_SENSOR_VER_2_0': 1, 'XN_SENSOR_VER_UNKNOWN': 0}
    _values_ = {0: 'XN_SENSOR_VER_UNKNOWN', 1: 'XN_SENSOR_VER_2_0',
                2: 'XN_SENSOR_VER_3_0', 3: 'XN_SENSOR_VER_4_0', 4: 'XN_SENSOR_VER_5_0'}
...
class XnHWVer(CEnum):
    _names_ = {'XN_SENSOR_HW_VER_RD1081': 5, 'XN_SENSOR_HW_VER_RD1082': 6, 'XN_SENSOR_HW_VER_FPDB_10': 1, 'XN_SENSOR_HW_VER_CDB_10': 2,
               'XN_SENSOR_HW_VER_UNKNOWN': 0, 'XN_SENSOR_HW_VER_RD_5': 4, 'XN_SENSOR_HW_VER_RD109': 7, 'XN_SENSOR_HW_VER_RD_3': 3}
    _values_ = {0: 'XN_SENSOR_HW_VER_UNKNOWN', 1: 'XN_SENSOR_HW_VER_FPDB_10', 2: 'XN_SENSOR_HW_VER_CDB_10', 3: 'XN_SENSOR_HW_VER_RD_3',
                4: 'XN_SENSOR_HW_VER_RD_5', 5: 'XN_SENSOR_HW_VER_RD1081', 6: 'XN_SENSOR_HW_VER_RD1082', 7: 'XN_SENSOR_HW_VER_RD109'}
...
class XnChipVer(CEnum):
    _names_ = {'XN_SENSOR_CHIP_VER_PS1000': 1, 'XN_SENSOR_CHIP_VER_PS1080': 2,
               'XN_SENSOR_CHIP_VER_PS1080A6': 3, 'XN_SENSOR_CHIP_VER_UNKNOWN': 0}
    _values_ = {0: 'XN_SENSOR_CHIP_VER_UNKNOWN', 1: 'XN_SENSOR_CHIP_VER_PS1000',
                2: 'XN_SENSOR_CHIP_VER_PS1080', 3: 'XN_SENSOR_CHIP_VER_PS1080A6'}
...
class XnCMOSType(CEnum):
    _names_ = {'XN_CMOS_TYPE_IMAGE': 0,
               'XN_CMOS_COUNT': 2, 'XN_CMOS_TYPE_DEPTH': 1}
    _values_ = {0: 'XN_CMOS_TYPE_IMAGE',
                1: 'XN_CMOS_TYPE_DEPTH', 2: 'XN_CMOS_COUNT'}
...
class XnIOImageFormats(CEnum):
    _names_ = {'XN_IO_IMAGE_FORMAT_UNCOMPRESSED_YUYV': 7, 'XN_IO_IMAGE_FORMAT_UNCOMPRESSED_YUV422': 5, 'XN_IO_IMAGE_FORMAT_UNCOMPRESSED_BAYER': 6,
               'XN_IO_IMAGE_FORMAT_BAYER': 0, 'XN_IO_IMAGE_FORMAT_JPEG': 2, 'XN_IO_IMAGE_FORMAT_JPEG_420': 3, 'XN_IO_IMAGE_FORMAT_JPEG_MONO': 4, 'XN_IO_IMAGE_FORMAT_YUV422': 1}
    _values_ = {0: 'XN_IO_IMAGE_FORMAT_BAYER', 1: 'XN_IO_IMAGE_FORMAT_YUV422', 2: 'XN_IO_IMAGE_FORMAT_JPEG', 3: 'XN_IO_IMAGE_FORMAT_JPEG_420',
                4: 'XN_IO_IMAGE_FORMAT_JPEG_MONO', 5: 'XN_IO_IMAGE_FORMAT_UNCOMPRESSED_YUV422', 6: 'XN_IO_IMAGE_FORMAT_UNCOMPRESSED_BAYER', 7: 'XN_IO_IMAGE_FORMAT_UNCOMPRESSED_YUYV'}
...
class XnIODepthFormats(CEnum):
    _names_ = {'XN_IO_DEPTH_FORMAT_UNCOMPRESSED_16_BIT': 0, 'XN_IO_DEPTH_FORMAT_COMPRESSED_PS': 1,
               'XN_IO_DEPTH_FORMAT_UNCOMPRESSED_12_BIT': 4, 'XN_IO_DEPTH_FORMAT_UNCOMPRESSED_11_BIT': 3, 'XN_IO_DEPTH_FORMAT_UNCOMPRESSED_10_BIT': 2}
    _values_ = {0: 'XN_IO_DEPTH_FORMAT_UNCOMPRESSED_16_BIT', 1: 'XN_IO_DEPTH_FORMAT_COMPRESSED_PS',
                2: 'XN_IO_DEPTH_FORMAT_UNCOMPRESSED_10_BIT', 3: 'XN_IO_DEPTH_FORMAT_UNCOMPRESSED_11_BIT', 4: 'XN_IO_DEPTH_FORMAT_UNCOMPRESSED_12_BIT'}
...
class XnParamResetType(CEnum):
    _names_ = {'XN_RESET_TYPE_POWER': 0,
               'XN_RESET_TYPE_SOFT': 1, 'XN_RESET_TYPE_SOFT_FIRST': 2}
    _values_ = {0: 'XN_RESET_TYPE_POWER',
                1: 'XN_RESET_TYPE_SOFT', 2: 'XN_RESET_TYPE_SOFT_FIRST'}
...
class XnSensorUsbInterface(CEnum):
    _names_ = {'XN_SENSOR_USB_INTERFACE_ISO_ENDPOINTS': 1, 'XN_SENSOR_USB_INTERFACE_DEFAULT': 0,
               'XN_SENSOR_USB_INTERFACE_BULK_ENDPOINTS': 2, 'XN_SENSOR_USB_INTERFACE_ISO_ENDPOINTS_LOW_DEPTH': 3}
    _values_ = {0: 'XN_SENSOR_USB_INTERFACE_DEFAULT', 1: 'XN_SENSOR_USB_INTERFACE_ISO_ENDPOINTS',
                2: 'XN_SENSOR_USB_INTERFACE_BULK_ENDPOINTS', 3: 'XN_SENSOR_USB_INTERFACE_ISO_ENDPOINTS_LOW_DEPTH'}
...
class XnProcessingType(CEnum):
    _names_ = {'XN_PROCESSING_HARDWARE': 1,
               'XN_PROCESSING_SOFTWARE': 2, 'XN_PROCESSING_DONT_CARE': 0}
    _values_ = {0: 'XN_PROCESSING_DONT_CARE',
                1: 'XN_PROCESSING_HARDWARE', 2: 'XN_PROCESSING_SOFTWARE'}
...
class XnCroppingMode(CEnum):
    _names_ = {'XN_CROPPING_MODE_SOFTWARE_ONLY': 3,
               'XN_CROPPING_MODE_INCREASED_FPS': 2, 'XN_CROPPING_MODE_NORMAL': 1}
    _values_ = {1: 'XN_CROPPING_MODE_NORMAL',
                2: 'XN_CROPPING_MODE_INCREASED_FPS', 3: 'XN_CROPPING_MODE_SOFTWARE_ONLY'}
...
class _anon_enum_28(CEnum):
    _names_ = {'XN_ERROR_STATE_OK': 0, 'XN_ERROR_STATE_DEVICE_PROJECTOR_FAULT': 1,
               'XN_ERROR_STATE_DEVICE_OVERHEAT': 2}
    _values_ = {0: 'XN_ERROR_STATE_OK', 1: 'XN_ERROR_STATE_DEVICE_PROJECTOR_FAULT',
...
class XnFirmwareCroppingMode(CEnum):
    _names_ = {'XN_FIRMWARE_CROPPING_MODE_DISABLED': 0,
               'XN_FIRMWARE_CROPPING_MODE_INCREASED_FPS': 2, 'XN_FIRMWARE_CROPPING_MODE_NORMAL': 1}
    _values_ = {0: 'XN_FIRMWARE_CROPPING_MODE_DISABLED',
                1: 'XN_FIRMWARE_CROPPING_MODE_NORMAL', 2: 'XN_FIRMWARE_CROPPING_MODE_INCREASED_FPS'}
...
class XnLogFilter(CEnum):
    _names_ = {'XnLogFilterAssert': 16, 'XnLogFilterError': 4, 'XnLogFilterAll': 65535, 'XnLogFilterProtocol': 8, 'XnLogFilterTelems': 256,
               'XnLogFilterFrameSync': 64, 'XnLogFilterInfo': 2, 'XnLogFilterAGC': 128, 'XnLogFilterConfig': 32, 'XnLogFilterDebug': 1}
    _values_ = {32: 'XnLogFilterConfig', 1: 'XnLogFilterDebug', 2: 'XnLogFilterInfo', 4: 'XnLogFilterError', 8: 'XnLogFilterProtocol',
                64: 'XnLogFilterFrameSync', 128: 'XnLogFilterAGC', 256: 'XnLogFilterTelems', 16: 'XnLogFilterAssert', 65535: 'XnLogFilterAll'}
    XnLogFilterDebug = 1
    XnLogFilterInfo = 2
    XnLogFilterError = 4
...
class XnFlashFileType(CEnum):
    ...
    _values_ = {0: 'XnFlashFileTypeFileTable', 1: 'XnFlashFileTypeScratchFile', 2: 'XnFlashFileTypeBootSector', 3: 'XnFlashFileTypeBootManager', 4: 'XnFlashFileTypeCodeDownloader', 5: 'XnFlashFileTypeMonitor', 6: 'XnFlashFileTypeApplication', 7: 'XnFlashFileTypeFixedParams', 8: 'XnFlashFileTypeDescriptors', 9: 'XnFlashFileTypeDefaultParams', 10: 'XnFlashFileTypeImageCmos', 11: 'XnFlashFileTypeDepthCmos', 12: 'XnFlashFileTypeAlgorithmParams', 13: 'XnFlashFileTypeReferenceQVGA', 14: 'XnFlashFileTypeReferenceVGA', 15: 'XnFlashFileTypeMaintenance',
                16: 'XnFlashFileTypeDebugParams', 17: 'XnFlashFileTypePrimeProcessor', 18: 'XnFlashFileTypeGainControl', 19: 'XnFlashFileTypeRegistartionParams', 20: 'XnFlashFileTypeIDParams', 21: 'XnFlashFileTypeSensorTECParams', 22: 'XnFlashFileTypeSensorAPCParams', 23: 'XnFlashFileTypeSensorProjectorFaultParams', 24: 'XnFlashFileTypeProductionFile', 25: 'XnFlashFileTypeUpgradeInProgress', 26: 'XnFlashFileTypeWavelengthCorrection', 27: 'XnFlashFileTypeGMCReferenceOffset', 28: 'XnFlashFileTypeSensorNESAParams', 29: 'XnFlashFileTypeSensorFault', 30: 'XnFlashFileTypeVendorData'}
...
class XnBistType(CEnum):
    _names_ = {'XN_BIST_FULL_FLASH': 16, 'XN_BIST_FLASH': 8, 'XN_BIST_TEC_TEST_MASK': 64, 'XN_BIST_NESA_UNLIMITED_TEST_MASK': 256, 'XN_BIST_POTENTIOMETER': 4, 'XN_BIST_PROJECTOR_TEST_MASK': 32,
               'XN_BIST_IMAGE_CMOS': 1, 'XN_BIST_NESA_TEST_MASK': 128, 'XN_BIST_ALL': '((4294967295 & (~XN_BIST_NESA_TEST_MASK)) & (~XN_BIST_NESA_UNLIMITED_TEST_MASK))', 'XN_BIST_IR_CMOS': 2}
    _values_ = {32: 'XN_BIST_PROJECTOR_TEST_MASK', 1: 'XN_BIST_IMAGE_CMOS', 2: 'XN_BIST_IR_CMOS', 4: 'XN_BIST_POTENTIOMETER', 8: 'XN_BIST_FLASH', 64: 'XN_BIST_TEC_TEST_MASK',
                128: 'XN_BIST_NESA_TEST_MASK', 256: 'XN_BIST_NESA_UNLIMITED_TEST_MASK', 16: 'XN_BIST_FULL_FLASH', '((4294967295 & (~XN_BIST_NESA_TEST_MASK)) & (~XN_BIST_NESA_UNLIMITED_TEST_MASK))': 'XN_BIST_ALL'}
...
class XnDepthCMOSType(CEnum):
    _names_ = {'XN_DEPTH_CMOS_AR130': 2,
               'XN_DEPTH_CMOS_MT9M001': 1, 'XN_DEPTH_CMOS_NONE': 0}
    _values_ = {0: 'XN_DEPTH_CMOS_NONE',
                1: 'XN_DEPTH_CMOS_MT9M001', 2: 'XN_DEPTH_CMOS_AR130'}
...
class _anon_enum_39(CEnum):
    _names_ = {'PS_PROPERTY_USB_INTERFACE': 489156609,
               'PS_PROPERTY_DUMP_DATA': 489095169}
    _values_ = {489095169: 'PS_PROPERTY_DUMP_DATA',
                489156609: 'PS_PROPERTY_USB_INTERFACE'}
    PS_PROPERTY_DUMP_DATA = 489095169
...
class XnBootErrorCode(CEnum):
    _names_ = {'XN_BOOT_OK': 0, 'XN_BOOT_FW_LOAD_FAILED': 3,
               'XN_BOOT_BAD_CRC': 1, 'XN_BOOT_UPLOAD_IN_PROGRESS': 2}
    _values_ = {0: 'XN_BOOT_OK', 1: 'XN_BOOT_BAD_CRC',
                2: 'XN_BOOT_UPLOAD_IN_PROGRESS', 3: 'XN_BOOT_FW_LOAD_FAILED'}
    XN_BOOT_OK = 0
    XN_BOOT_BAD_CRC = 1
...
class XnFwStreamType(CEnum):
    _names_ = {'XN_FW_STREAM_TYPE_IR': 2, 'XN_FW_STREAM_TYPE_COLOR': 1, 'XN_FW_STREAM_TYPE_SHIFTS': 3,
               'XN_FW_STREAM_TYPE_LOG': 8, 'XN_FW_STREAM_TYPE_AUDIO': 4, 'XN_FW_STREAM_TYPE_DY': 5}
    _values_ = {1: 'XN_FW_STREAM_TYPE_COLOR', 2: 'XN_FW_STREAM_TYPE_IR', 3: 'XN_FW_STREAM_TYPE_SHIFTS',
                4: 'XN_FW_STREAM_TYPE_AUDIO', 5: 'XN_FW_STREAM_TYPE_DY', 8: 'XN_FW_STREAM_TYPE_LOG'}
...
class XnFwPixelFormat(CEnum):
    _names_ = {'XN_FW_PIXEL_FORMAT_SHIFTS_9_3': 1, 'XN_FW_PIXEL_FORMAT_NONE': 0,
               'XN_FW_PIXEL_FORMAT_GRAYSCALE16': 2, 'XN_FW_PIXEL_FORMAT_BAYER8': 4, 'XN_FW_PIXEL_FORMAT_YUV422': 3}
    _values_ = {0: 'XN_FW_PIXEL_FORMAT_NONE', 1: 'XN_FW_PIXEL_FORMAT_SHIFTS_9_3',
                2: 'XN_FW_PIXEL_FORMAT_GRAYSCALE16', 3: 'XN_FW_PIXEL_FORMAT_YUV422', 4: 'XN_FW_PIXEL_FORMAT_BAYER8'}
...
class XnFwCompressionType(CEnum):
    _names_ = {'XN_FW_COMPRESSION_8Z': 1, 'XN_FW_COMPRESSION_6_BIT_PACKED': 4, 'XN_FW_COMPRESSION_16Z': 2, 'XN_FW_COMPRESSION_24Z': 3,
               'XN_FW_COMPRESSION_11_BIT_PACKED': 6, 'XN_FW_COMPRESSION_12_BIT_PACKED': 7, 'XN_FW_COMPRESSION_10_BIT_PACKED': 5, 'XN_FW_COMPRESSION_NONE': 0}
    _values_ = {0: 'XN_FW_COMPRESSION_NONE', 1: 'XN_FW_COMPRESSION_8Z', 2: 'XN_FW_COMPRESSION_16Z', 3: 'XN_FW_COMPRESSION_24Z',
                4: 'XN_FW_COMPRESSION_6_BIT_PACKED', 5: 'XN_FW_COMPRESSION_10_BIT_PACKED', 6: 'XN_FW_COMPRESSION_11_BIT_PACKED', 7: 'XN_FW_COMPRESSION_12_BIT_PACKED'}
...
OniDeviceInfoCallback = _get_calling_conv(
    None, ctypes.POINTER(OniDeviceInfo), ctypes.c_void_p)
OniDeviceStateCallback = _get_calling_conv(
    None, ctypes.POINTER(OniDeviceInfo), OniDeviceState, ctypes.c_void_p)
OniFrameAllocBufferCallback = _get_calling_conv(
    ctypes.c_void_p, ctypes.c_int, ctypes.c_void_p)
OniFrameFreeBufferCallback = _get_calling_conv(
...
def load_dll(dllname):
    ...
    _oniGetDeviceList.argtypes = [ctypes.POINTER(
        ctypes.POINTER(OniDeviceInfo)), ctypes.POINTER(ctypes.c_int)]
    ...
    _oniDeviceOpen.argtypes = [
        ctypes.c_char_p, ctypes.POINTER(OniDeviceHandle)]
    ...
    _oniDeviceGetInfo.argtypes = [
        OniDeviceHandle, ctypes.POINTER(OniDeviceInfo)]

    global _oniDeviceCreateStream
    _oniDeviceCreateStream = dll.oniDeviceCreateStream
    _oniDeviceCreateStream.restype = OniStatus
    _oniDeviceCreateStream.argtypes = [
        OniDeviceHandle, OniSensorType, ctypes.POINTER(OniStreamHandle)]
    ...
    _oniDeviceSetProperty.argtypes = [
        OniDeviceHandle, ctypes.c_int, ctypes.c_void_p, ctypes.c_int]

    global _oniDeviceGetProperty
    _oniDeviceGetProperty = dll.oniDeviceGetProperty
    _oniDeviceGetProperty.restype = OniStatus
    _oniDeviceGetProperty.argtypes = [
        OniDeviceHandle, ctypes.c_int, ctypes.c_void_p, ctypes.POINTER(ctypes.c_int)]
    ...
    _oniDeviceInvoke.argtypes = [OniDeviceHandle,
    ...
    _oniDeviceIsImageRegistrationModeSupported.argtypes = [
        OniDeviceHandle, OniImageRegistrationMode]

    global _oniDeviceOpenEx
    _oniDeviceOpenEx = dll.oniDeviceOpenEx
    _oniDeviceOpenEx.restype = OniStatus
    _oniDeviceOpenEx.argtypes = [ctypes.c_char_p,
                                 ctypes.c_char_p, ctypes.POINTER(OniDeviceHandle)]
    ...
    _oniStreamReadFrame.argtypes = [
        OniStreamHandle, ctypes.POINTER(ctypes.POINTER(OniFrame))]
    ...
    _oniStreamRegisterNewFrameCallback.argtypes = [
        OniStreamHandle, OniNewFrameCallback, ctypes.c_void_p, ctypes.POINTER(OniCallbackHandle)]
    ...
    _oniStreamUnregisterNewFrameCallback.argtypes = [
        OniStreamHandle, OniCallbackHandle]

    global _oniStreamSetProperty
    _oniStreamSetProperty = dll.oniStreamSetProperty
    _oniStreamSetProperty.restype = OniStatus
    _oniStreamSetProperty.argtypes = [
        OniStreamHandle, ctypes.c_int, ctypes.c_void_p, ctypes.c_int]

    global _oniStreamGetProperty
    _oniStreamGetProperty = dll.oniStreamGetProperty
    _oniStreamGetProperty.restype = OniStatus
    _oniStreamGetProperty.argtypes = [
        OniStreamHandle, ctypes.c_int, ctypes.c_void_p, ctypes.POINTER(ctypes.c_int)]
    ...
    _oniStreamInvoke.argtypes = [OniStreamHandle,
                                 ctypes.c_int, ctypes.c_void_p, ctypes.c_int]
    ...
    _oniCreateRecorder.argtypes = [
        ctypes.c_char_p, ctypes.POINTER(OniRecorderHandle)]
    ...
    _oniRecorderAttachStream.argtypes = [
        OniRecorderHandle, OniStreamHandle, OniBool]
